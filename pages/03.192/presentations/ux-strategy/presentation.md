...
---
<!--
# Example Grav Open Course Hub High-level User Stories

As a _student_,  
I want to _easily contact the instructor with questions_  
so that _I can be sure to understand the materials correctly_.

As an _instructor_,  
I want to _have students suggest course material improvements_  
so that _everyone can benefit from each other’s experiences and knowledge_.
...
# Grav Open Course Hub Design Principles (Students):
...
# Grav Open Course Hub Design Principles (Faculty):

* Controllable
* Pliable
* Portable
* Efficient
* Enjoyable (hey, us educators are people too...)
